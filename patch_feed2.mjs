...
const viewStart = content.indexOf('"/": function () {');
const targetStart = content.indexOf('var user = getUser();', viewStart);
const targetEnd = content.indexOf('    "/walkthroughs": function (id) {', targetStart);

if (viewStart === -1 || targetStart === -1 || targetEnd === -1) {
...
const newContent = content.slice(0, targetStart) + replacement + content.slice(targetEnd);

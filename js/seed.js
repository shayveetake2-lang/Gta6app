  ...
  walkthroughs: [
    {
      ...
      cover: "🏁",
      summary:
        "Make the most of the 27 August to 2 September Drift and Transform event, including the three-race GTA$100,000 challenge.",
    ...
    },
    {
      ...
      cover: "💨",
      summary:
        "Learn controlled oversteer, avoid common mistakes, and prepare an eligible car for Drift Races.",
    ...
    },
    {
      ...
      cover: "🔧",
      summary:
        "A practical route for running Auto Shop Robbery Contracts during the 2x reward event week.",
    ...
    },
    {
      ...
      cover: "🚘",
      summary:
        "Track the weekly Podium Vehicle, Prize Ride requirement, and the 30 percent discount watchlist.",
    ...
    },
    {
      ...
      cover: "💰",
      summary:
        "A flexible weekend route for the 28 to 30 August six-times reward window and the rest of Drift Week.",
    ...
    },
    {
      ...
      summary:
        "Complete the opening heist and escape the county line without losing wanted stars.",
      tags: ["story", "beginner"],
      steps: [
    ...
    },
    {
      ...
      summary:
        "Region-by-region route for every hidden collectible with the fastest travel order.",
    ...
    },
    {
      ...
      summary:
        "Loadout, cover positions and timing windows for the final confrontation.",
      tags: ["combat", "endgame"],
      steps: [
    ...
    },
    {
      ...
      summary:
        "Repeatable early-game income loop that requires no upfront investment.",
      ...
      replies: [
        {
          ...
          author: "sable",
          createdAt: "2026-08-24",
          body: "Drop volumetrics to medium first, it is worth ~12fps.",
        },
        {
          id: "r-2",
          author: "nova",
          createdAt: "2026-08-25",
          body: "Also cap the framerate, the frametimes get much smoother.",
        },
      ],
    },
    {
      ...
      replies: [
        {
          ...
          body: "The chapter 3 photo one is definitely missable.",
        },
      ],
    },
    {
  ...
  pendingWalkthroughs: [
    {
      ...
      summary:
        "Detailed coordinate points and times for rare muscle cars in the industrial shipping docks.",
      tags: ["vehicles", "secrets", "vice-port"],
      steps: [
        {
          title: "Head to the East Cranes",
          content:
            "Arrive at the shipping yard between 02:00 and 04:00 in-game time.",
        },
        {
          title: "Check Warehouse 4B",
          content:
            "The shutter door has a small opening on the south side where the vehicle spawns.",
        },
      ],
    },
  ],
  news: [
    {
      ...
      category: "Official",
      content:
        "GTA 6 will officially release on Thursday, November 19, 2026, for the PlayStation 5 and Xbox Series X/S.",
    ...
    },
    {
      ...
      category: "Official",
      content:
        "The campaign takes up to 80 hours to beat, and the game is capped at 30fps on consoles. The budget reportedly surpassed 1 to 2 billion dollars.",
      sourceLink: "https://rockstargames.com/newswire",
      isApproved: true,
      author: "admin",
      authorUid: "admin",
    ...
    },
    {
      ...
      category: "Official",
      content:
        'Features dual protagonists, Lucia Caminos and Jason Duval. They have a modern "Bonnie and Clyde" dynamic, but romance is optional and must be actively nurtured.',
      sourceLink: "https://rockstargames.com/newswire",
      isApproved: true,
      author: "admin",
      authorUid: "admin",
    ...
    },
    {
      ...
      category: "Official",
      content:
        "Players can gain or lose weight, and sleep deprivation will visibly show on their faces.",
      sourceLink: "https://rockstargames.com/newswire",
      isApproved: true,
      author: "admin",
      authorUid: "admin",
    ...
    },
    {
      ...
      category: "Leaks",
      content:
        'A group known as "CyberLeek" released footage showing a basketball minigame with a "Focus" mechanic, a taser weapon, and key-cloning for vehicles.',
      sourceLink: "",
      isApproved: true,
      author: "admin",
      authorUid: "admin",
...
export const TROPHIES = [
  ...
  },
  {
    ...
    description: "Complete a mission without raising your wanted level.",
    category: "Story",
    tier: "Bronze",
  },
  {
    ...
    description: "Visit every major district in the city.",
  ...
  },
  {
    id: "t-06",
    title: "Four Wheels",
    description: "Collect 10 unique vehicles.",
    category: "Exploration",
    tier: "Bronze",
  },
  {
    id: "t-07",
    title: "Big Score",
    description: "Earn $1,000,000 from side activities.",
  ...
  },
  {
    id: "t-08",
    title: "Night Shift",
    description: "Finish a full night of taxi work.",
    category: "Side Activities",
    tier: "Bronze",
  },
  {
    id: "t-09",
    title: "Local Legend",
    description: "Reach maximum reputation with one crew.",
    category: "Side Activities",
    tier: "Silver",
  },
  {
    id: "t-10",
    title: "Sharp Eye",
    description: "Find 10 hidden photo spots.",
    category: "Collectibles",
    tier: "Bronze",
  },
  {
    id: "t-11",
    title: "Full Deck",
    description: "Collect every special playing card.",
    category: "Collectibles",
    tier: "Silver",
  },
  {
    ...
    description: "Complete a full treasure map.",
    category: "Collectibles",
    tier: "Bronze",
  },
];
